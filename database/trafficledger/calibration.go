...
// NormalizedResetDay returns the default monthly reset day for invalid values.
...
// CycleContaining returns the calendar cycle start containing at.
...
// NextCycleStart returns the next monthly cycle boundary, clamped to month end.
