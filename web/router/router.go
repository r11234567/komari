...
func registerPublicRoutes(r *gin.Engine) {
	...
	r.GET("/api/records/load", jsonRpc.Bind("public:getRecordsByUUID", jsonRpc.WithQuery("uuid", "load_type", "hours", "max_points")))
	r.GET("/api/records/ping", jsonRpc.Bind("public:getPingRecords", jsonRpc.WithQuery("uuid", "task_id", "hours", "max_points")))
	r.POST("/api/v1/history/query", jsonRpc.Bind("public:queryHistory", jsonRpc.WithRaw()))
